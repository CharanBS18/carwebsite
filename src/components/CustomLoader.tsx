...
export const CustomLoader = () => {
  ...
  // Add a slight delay before unmounting to allow a fade-out animation
  useEffect(() => {
    if (!active) {
  ...
  return (
    <div className={`custom-loader-overlay ${active ? 'fade-in' : 'fade-out'}`}>
      <div className="loader-content">
        ...
        <p className="loading-text">LOADING TACTICAL ASSETS... {progress.toFixed(0)}%</p>
      </div>
    </div>
  )
}
